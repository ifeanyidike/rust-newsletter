...
async fn subscribe_returns_a_200_for_valid_form_data() {
    ...
    // Act
    let body = "name=ifeany%20dike&email=ifeanyidike87%40gmail.com";
    let response = client
    ...
    assert_eq!(saved.email, "ifeanyidike87@gmail.com");
...
async fn subscribe_returns_a_400_when_data_is_missing() {
    ...
    let test_cases = vec![
        ...
        ("email=ifeanyidike87%40gmail.com", "missing the name"),
